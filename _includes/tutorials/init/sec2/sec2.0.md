The prim.json file describes lattice vectors, basis sites, and degrees of freedom.
```
$ mkdir -p $CASM_TEST_PROJECTS_DIR/0.3.X/ZrO_tutorial$ cd $CASM_TEST_PROJECTS_DIR/0.3.X/ZrO_tutorial$ cp $CASM_TEST_PROJECTS_DIR/0.3.X/ZrO.0/prim.json .$ cat prim.json
```
